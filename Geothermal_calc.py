...
st.markdown(f"""
**This analysis compares Geothermal, Diesel, and Solar projects on an 'apple-to-apple' baseload
perspective, ensuring each technology delivers the same total energy output of
{R['total_energy_gwh']:.2f} GWh over a 25-year lifetime.**
...
**Overall Conclusion:** For a truly 'apple-to-apple' baseload comparison delivering the same total energy
over 25 years, **Geothermal emerges as the most balanced and strategically robust option**, offering
strong economic performance relative to Diesel, and unmatched reliability compared to Solar.
""")
